...
- **직접 쓰는 테이스팅 노트 (Manual Writing)**: AI가 대신 써주는 리뷰가 아닙니다. 50여 가지의 **미식 키워드(식감, 향미, 뉘앙스)**를 선택하고, 이를 바탕으로 나만의 감각적인 기록을 **직접 작성**합니다.
- **상세 평가 (Detailed Evaluation)**: 맛(The Palate)과 공간(The Vibe)을 분리하여 상세하게 평가합니다.
